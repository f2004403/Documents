...
\item[] M.S. \href{http://www.cs.stanford.edu/}{Computer Science}\hfill{GPA: 3.86 / 4.0}
      \begin{innerlist}
        ...
        \item Recipient of the prestigious \emph{BPCL Scholarship} awarded by Bharat Petroleum Corporation Ltd. awarded to an elite few for graduate study in the US.
         ...
         \item \emph{Relevant Coursework:} Machine Learning, Data Mining \& E-Business, Elements of Statistical Learning, Computational Advertising, Information Retrieval \& Web Search, Probabilistic Graphical Models, Data Mining, Transaction Processing and Distributed Databases, Network Analysis.
...
%\end{outerlist}
\begin{outerlist}
\item[] Software Engineer - Internet Services Advanced Data Analytics
	\begin{outerlist}
		\item[] Fraud Detection on iTunes AppStore % \hfill{Sep '11 - May '13}
		\begin{innerlist}
			\item Responsible for the end-to-end development of a solution to tackle reputation fraud on the iTunes AppStore as a part of a small team; involved right from requirements gathering and conception to design, implementation and evaluation. 
			\item Experienced with application of data mining, network analysis and machine learning techniques on massive scale data.
			\item Implemented a high performance subsystem that used stream mining to risk transactions on real time data streams.
...
\begin{outerlist}
	...
	\begin{innerlist}
		\item Worked on identification and analysis of interesting actionable patterns in the Maps logs using large scale data mining and machine learning techniques.
	\end{innerlist}
\end{outerlist}
...
\begin{innerlist}
        ...
        \item {Part of a two-member team that was responsible for the project from its conception and design to implementation and production deployment.}
