...
\item[] Software Engineer - Internet Services Advaced Data Analytics
	\begin{outerlist}
		...
		\begin{innerlist}
			...
			\item Implemented a scalable version of the \emph{Belief propagation} that works on k-partite graphs with billions of nodes.
...
\emph{STAIR : System for Topical and Aggregated Information Retrieval.}
       ...
       \begin{compactitem}
        \item {Developed the architecture and the prototype of STAIR - an IR system that  applied of a combination of Collaborative analysis and Focused Crawling techniques on the web documents to provide personalized, consolidated information relevant to the user as an aggregated PDF document.}        
        \item {Implemented in on Java using Lucene. The semantics were obtained from WordNet.}
