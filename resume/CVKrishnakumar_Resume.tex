...
\item[] Software Engineer - Internet Services \hfill{Jan '12 - May '13}
	...
	\begin{outerlist}
		...
		\begin{innerlist}
			...
			\item Used Pig, Java MapReduce, Mahout, HBase, Sqoop on the Hadoop ecosystem.
		\end{innerlist}
	\end{outerlist}
	...
	\begin{outerlist}
		...
		\begin{innerlist}
			...
			\item Implementation and testing in Java.
		\end{innerlist}
	\end{outerlist}
...
\emph{Tools and  Platforms}: Teradata, Weka, R, Eclipse, \LaTeX{}, Octave\\
