...
\section{\textbf{Interests}} Data Mining and Analysis, Machine Learning, Information Retrieval
...
\item[] M Sc.(Tech.) {Information Systems} \hfill{CGPA : 9.95/10.0}
        \begin{innerlist}
        \item Ranked No. 1 in Information Systems Department
...
\href{http://www.apple.com}{\textbf{Apple Inc.}},\hspace{1cm}\textit{Software Engineer}\hfill \textit{Apr '10 to Mar '13}\\
 \emph{Internet Services Group}
       \begin{compactitem}
        \item {Worked on Spam and Fraud Detection problems using Machine Learning and large scale data mining techniques. }
       \end{compactitem}
...
\href{http://www.apple.com}{\textbf{Apple Inc.}},\hspace{1cm}\textit{Summer Intern}\hfill \textit{June 09 to Mar 10}\\
 \emph{Internet Services Group}
       ...
       % \item \emph{Mentor : Mr. Vipul Pandey}
       \end{compactitem}
...
\emph{Tools and  Platforms}: Mahout, Teradata,  Weka, Eclipse,\LaTeX{} , Octave, Weka\\
