...
\newcommand{\spcless}{\vspace{0.8mm}}
...
Sunnyvale, CA-94087   &  \textit{Ph: 650-384-9476} 
\end{tabular}
...
\item[] M.S. \href{http://www.cs.stanford.edu/}{Computer Science}\hfill{GPA : 3.86 / 4.0}
      \begin{innerlist}
        \item Recipient of the prestigious \emph{BPCL Scholarship} awarded by Bharat Petroleum Corporation Ltd. awarded to the elite few for graduate study in the US.
         ...
         \item \emph{Relevant Coursework : } \href{http://cs229.stanford.edu}{Machine Learning},  Data Mining \& E-Business (A+), \href{http://www.stanford.edu/}{Modern Applied Statistical Learning }, \href{http://www.stanford.edu/class/msande239/}{Computational Advertising(A+)}, \href{http://cs276.stanford.edu}{ Information Retrieval \& Web Search }(A),  \href{http://cs228.stanford.edu}{Probabilistic Graphical Models}(A), \href{http://cs345a.stanford.edu}{Data Mining}(A), \href{http://cs347.stanford.edu}{Transaction Processing and Distributed Databases}, \href{http://snap.stanford.edu/na09/}{Network Analysis}.
...
%%{\textbf{DAV Boys' Sr. Sec. School Gopalapuram}}
%%\begin{outerlist}
%%\item[] AISSCE, May 2004 \hfill{95.2\%}
%%        \begin{compactitem}
%%        \item Listed in the Merit List by the \href{http://www.cbse.nic.in}{Central Board of Secondary Education (CBSE)} for proficiency in English.
%%        \end{compactitem}
%%\end{outerlist}
%% Add CGPA here
%
...
\href{http://www.apple.com}{\textbf{Apple Inc.}}\hfill \textit{Apr '10 to Mar '13}\\

\begin{outerlist}
\item[] Software Engineer - Maps Data Validation \hfill{May '13 - present}
        \begin{innerlist}
	\item TODO
        \end{innerlist}
\end{outerlist}
...
\begin{outerlist}
\item[] Software Engineer - Internet Services \hfill{Jan '12 - May '13}

	\begin{outerlist}
		\item[] Reputation/Indirect Fraud Detection on iTunes Appstore \hfill{Sep '11 - May '13}
		\begin{innerlist}
			\item TODO
		\end{innerlist}
	\end{outerlist}
	...
	\item[] Spam Detection on iTunes Ping comments \hfill{Apr '10 - June '11}
	        \begin{innerlist}
	        \item TODO Worked on machine learning techniques for spam detection on Ping.
	        \end{innerlist}
	\end{outerlist}
...
%\begin{outerlist}
%\item[] Software Engineer \hfill{Jan '12 - May '12}
%        \begin{innerlist}
%	\item TODO
%        \end{innerlist}
%\end{outerlist}
%
%\begin{outerlist}
%\item[] Software Engineer \hfill{Apr '10 - Apr '11}
%        \begin{innerlist}
...
\begin{compactitem}
\item {Designed and implemented a system for selection of most appropriate answerers in \emph{Yahoo! Answers} based on textual, structural and other auxiliary information. The result could be used to determine the routing for the new questions.}
...
\emph{Frameworks}: Hadoop (Cloudera Certified Hadoop Developer), HBase \\
\emph{Tools and  Platforms}: Mahout, Teradata, Weka, R, Eclipse, \LaTeX{}, Octave\\
